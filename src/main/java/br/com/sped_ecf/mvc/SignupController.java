...
public class SignupController {
    ...
    public String signupForm(@ModelAttribute br.com.sped_ecf.config.User user) {
        return "user/signup";
    }

    @RequestMapping(method = RequestMethod.POST)
    public String signup(@Valid br.com.sped_ecf.config.User user, BindingResult result,
