...
import br.com.sped_ecf.data.*;
import br.com.sped_ecf.mvc.MessageForm;
...
public class MessageController {
    ...
    public String create(@br.com.sped_ecf.config.CurrentUser br.com.sped_ecf.config.User currentUser, @Valid MessageForm messageForm, BindingResult result, RedirectAttributes redirect) {
        br.com.sped_ecf.config.User to = userRepository.findByEmail(messageForm.getToEmail());
        if(to == null) {
